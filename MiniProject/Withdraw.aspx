<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Withdraw.aspx.cs" Inherits="MiniProject.WebForm1" %>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 home-controller-2">
        <div class="col-md-4 col-sm-4 col-xs-12 form-container-2">
            ...
            <div class="form-group">
                <label for="TextBox1">Money to be withdrawn</label>
            ...
            <div class="form-group two-buttons">
                <asp:Button runat="server" CssClass="form-control btn btn-primary btn-success float-left" Text="Withdraw" OnClick="Unnamed2_Click" />
            </div>
        </div>
    </div>
</asp:Content>
